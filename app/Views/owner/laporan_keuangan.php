                ...
                <tbody>
                    <?php foreach ($laporan as $item) : ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($item['tipe'] == 'Pemasukan' || $item['tipe'] == 'DP' || $item['tipe'] == 'Pelunasan'): ?>
                                    <span class="badge badge-success"><?= esc($item['tipe']); ?></span>
                                <?php else: ?>
                                    <span class="badge badge-danger"><?= esc($item['tipe']); ?></span>
                                <?php endif; ?>
                            </td>
